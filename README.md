...
| WorkOrdersModule | done — state machine, assignments, intervention, on-hold, validation, checklist, automatic priority escalation, duplicate guard, source report panel, overdue highlighting, promote terminal guard, WO_RESUMED/LINKED_WO_CLOSED/DUE_DATE_APPROACHING/VALIDATION_REMINDER_24H notifications, notification deep-linking, analytics cost summary, PDF cost breakdown |
